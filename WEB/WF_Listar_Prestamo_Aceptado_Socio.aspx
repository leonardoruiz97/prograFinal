...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="nombreProducto" style="margin-left: 328px">Lista de Prestamo Aceptados</div>
    ...
    <img src="img/cabecera.png" alt="..." " height="60"  >
        ...
        <asp:GridView ID="gv_Tabla_Prestamo_Aceptado_Socio" runat="server" EmptyDataText="Usted no tiene prestamos aceptados" OnRowCommand="gv_Tabla_Prestamo_Aceptado_Socio_RowCommand" OnPageIndexChanging="gv_Tabla_Prestamo_Aceptado_Socio_PageIndexChanging" OnRowDataBound="gv_Tabla_Prestamo_Aceptado_Socio_RowDataBound" CssClass="table table-bordered table-hover" Width="65%" AutoGenerateColumns="False" GridLines="None">
            ...
            <columns>
                 ...
                 <asp:BoundField DataField="PK_IPre_Cod" HeaderText="Nº Prestamo" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center">
                   ...
                   <asp:BoundField DataField="NombreCompleto" HeaderText="Datos Completos" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center">
                    <headerstyle cssclass="text-center"></headerstyle>
