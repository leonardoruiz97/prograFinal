...
<%--    <div class="field" id="searchform">
    ...
    <asp:Label ID="txtestadoGrid" runat="server" Text="" Visible="false"></asp:Label>
       <div style="margin-left:50px">
        ...
        <asp:GridView ID="gv_Tabla_Lista_Prestamo_Denegados" runat="server" OnRowCommand="gv_Tabla_Lista_Prestamo_Denegados_RowCommand" OnPageIndexChanging="gv_Tabla_Lista_Prestamo_Denegados_PageIndexChanging" EmptyDataText="No hay Prestamos aceptados" CssClass="table-responsive-sm table-hover" Width="95%" AutoGenerateColumns="False" GridLines="None" OnRowDataBound="gv_Tabla_Lista_Prestamo_Denegados_RowDataBound">
            <columns>
